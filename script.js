                     ...
                     "children":
                        [
                            ...
                            "right_link_explanation": "Here, we are concerned with statements like “90% of the people who actually need housing assistance in group A are denied housing, compared to only 10% of people who actually need housing assistance in group B.”", 
                             "rule":"big", 
                             "children": [ 
                                {"name": "False Negative Count Parity #FN", "rule":"Do you want to focus on the counts of false negative errors across groups so that they are the same?", 
                                ...
                                {"name": "False Negative Proportion Parity FN/N", "rule":"Do you want to focus on the proportion of people from the group(s) that are false negatives?", 
                                ...
                                {"name": "False Omission Parity FN/(TN+FN)", "rule":"Do you want to make sure you are wrong about the same proportion of people who the model predicts should not receive the intervention from each group and who are false negatives?", 
                                ...
                                {"name": "False Negative Rate parity  FN/(TP + FN) ", "rule":"Do you want to make sure you are wrong about the same proportion of people who are appropriate for the intervention but who may be false negatives?", 
